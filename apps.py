...
xgb = XGBClassifier()
xgb.load_model("xgb_models.json")
one_hot_columns = joblib.load("one_hot__columns.pkl")
...
with st.form("churn_form"):
    ...
    with col2:
        ...
        is_active_member = st.number_input("Active Member (1 for Yes, 0 for No)", min_value=0, max_value=1, value=1, step=2)
